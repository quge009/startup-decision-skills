"""Build chip interface_events v0.3 parquet from per-company JSON cache."""
...
OUTPUT_PATH = DATA_ROOT / "interface_events_chip_v0.3.parquet"
...
def parse_args() -> argparse.Namespace:
    ap = argparse.ArgumentParser(
        description="Build interface_events chip v0.3 parquet from JSON cache")
