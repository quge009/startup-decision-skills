"""Build independent M-check Tavily queries from candidate placeholders.
...
<working_dir>/market_queries.json.
...
from templates import M_CHECK_TEMPLATES  # noqa: E402
...
def main():
    ...
    parser.add_argument("--output-file", help="Output path (default: <working_dir>/market_queries.json)")
    ...
    out_path = Path(args.output_file) if args.output_file else working_dir / "market_queries.json"
